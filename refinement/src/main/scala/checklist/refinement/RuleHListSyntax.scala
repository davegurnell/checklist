...
//     */
//    def check[C, D, E: ToPath](path: E, f: A => C)(newRule: Rule[C, D]): Rule[A, D :: B] =
...
//      * @tparam C The raw, unvalidated type which is pulled out of an `A`
//      */
//    def checkAndDrop[P: ToPath, C](path: P, f: A => C)(rule: Rule[C, _]): Rule[A, B] =
